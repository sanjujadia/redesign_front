    ...
    const fetchRecipes = async () => {
        ...
        try {
            ...
            if (data.status && data.data.length > 0) {
                ...
                // No recipe data found, handle it
                    ...
                    <Row>
                        ...
                        <Col lg={8}>
                            <div className='text-end'>
                                ...
                                <Link to={recipeData.length > 0 ? "/create-recipe" : "/add-user-recipe"} className='px-3 py-2 rounded text-white mb-0 fw-600 fs-17 bg-green custom-shadow border-0 px-3 text-decoration-none'><svg className='me-2' xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
